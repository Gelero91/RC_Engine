...
// Raytex correspond a une coordonnée qui est remplacé par une variable renvoyé à l'ID de la texture
		// Vérifier si les valeurs corespondent à une variable de texture
		...
		// Si différent de zéro (sol), alors on renvoie une texture ou un rendu spécial (ex : portes)
		if (rayTex != 0) {
